        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="md:hidden block">
            {steps
                ...
                <div
                    key={step}
                    className="flex items-center gap-1 text-[#004e45] font-semibold"
                >
                    <span className="rounded-full w-5 h-5 text-xs flex items-center justify-center bg-[#004e45] text-white">
                    {step}
                    </span>
                    {label}
                </div>
                ...
                <React.Fragment key={step}>
                  <div
                    className={`flex items-center gap-1 ${
                      isCurrent ? "text-[#004e45] font-semibold" : "text-gray-500"
                    }`}
                  >
                    <span
                      ...
                      ${
                        isCurrent
                          ? "bg-[#004e45] text-white"
                          : isCompleted
                          ? "bg-[#659e97] text-white"
