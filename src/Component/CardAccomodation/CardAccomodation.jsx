    ...
    <div className="max-w-5xl  mx-auto p-4 sm:p-6 lg:p-8">
      <div className="bg-white border shadow-lg accomodation overflow-hidden">
        ...
        <div className="p-4 flex justify-between">
            <ButtonSearch onClick={handleAddToCart} className="  justify-center  items-center    flex  cursor-pointer z-40   w-[250px] bg-[#004e45] text-white py-4    rounded-full hover:bg-[ff7a45px] transition duration-200">
