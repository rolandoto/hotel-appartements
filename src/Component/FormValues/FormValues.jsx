                    ...
                    <div className=" mx-auto  rounded-md ">
                        ...
                        <h2 className="text-xl font-semibold">Método de Pago</h2>
                            ...
                            <label className="flex items-center">
                                ...
                                />
                                <span className="ml-2 text-gray-700">He leído y acepto las <a target="_blank" href={pdf} className="text-green-500">condiciones generales</a> (*)</span>
                            </label>
                            ...
                            <label className="flex items-center">
                                ...
                                className="form-checkbox h-5 w-5 text-gray-600"
                                />
                                <span className="ml-2 text-gray-700">He leído y acepto los <a  target="_blank" href={pdf} className="text-green-500">Términos y Condiciones del sitio web</a> (*)</span>
                            </label>
                            ...
                            Al completar esta reserva, acuerdo que he leído y aceptado las <a target="_blank" href={pdf} className="text-green-500">Políticas de Propiedad</a>.
                        </p>
                    </div>
                    </form>)
