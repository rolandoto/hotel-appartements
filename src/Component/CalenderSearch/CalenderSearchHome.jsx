    ...
    return (
        <MainAccomodation className="  lg:flex   mx-auto   max-w-5xl items-center justify-between p-4 lg:px-8">
            <MainProduct className="mx-auto  	 lg:flex  items-center justify-between p-4 rounded-lg shadow-2xl ">
                            ...
                            <ButtonSearch className=" lg:hidden  block  w-full bg-[#004E45] text-white py-4    rounded hover:bg-green-500 transition duration-200" onClick={onsubmit}>
                                        Verificar disponibilidad
                                </ButtonSearch>

                                <ButtonSearch className=" hidden  lg:block w-[150px]   bg-[#004E45]  text-white py-4    rounded hover:bg-green-500 transition duration-200" onClick={onsubmit}>
                                         Verificar disponibilidad
                                </ButtonSearch>
