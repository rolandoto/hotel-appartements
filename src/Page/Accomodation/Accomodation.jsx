    ...
    const FillContent =()=>{
      ...
      if(loading){
       ...
       return  (
        ...
        return <> 
        <MainProduct className="m-auto flex bg-[#004e45] " >
          
        <div className="p-4  rounded-[40px]     text-white   m-auto max-w-5xl flex flex-col md:flex-row justify-between items-start md:items-center">
      ...
      return (<div>
          ...
          <div className=" lg:flex hidden p-2 lg:px-8" >
              <MainProduct className="m-auto flex ">
                <div className="flex lg:w-[47%] w-[100%] justify-center  bg-[#004e45] rounded-[40px]  p-4  items-center space-x-1">
            ...
            <div className="lg:hidden flex  p-2 lg:px-8" >
              <MainProduct className="m-auto ">
                <div className="flex lg:w-[47%] w-[100%] justify-center bg-[#004e45] rounded-[40px]  p-4  items-center space-x-1">
                  <span className="bg-white text-white rounded-full w-6 h-6 flex items-center justify-center text-sm">1</span>
                  <span className=" text-white">Elegir un espacio
                  </span>
                </div>
              </MainProduct>
            ...
            {isVisible && <div className="fixed top-48 left-0 right-4 flex justify-center z-40">
              <div className="w-[90%] md:w-full max-w-md bg-black text-white rounded-3xl shadow-lg overflow-hidden flex">
                ...
                <div className="w-1/2 relative">
                  <img
                    src="https://h-img2.cloudbeds.com/uploads/315188/img_1126_gallery~~66646447ed984.jpg"
                    alt="Luxury Suite"
              ...
              {scrolledbook && (
                <div className="w-full  animation z-40 lg:hidden bg-white fixed top-[50px] p-4  shadow-md ">
                  <div className="flex items-center justify-between text-gray-700 ">
                    ...
                    <div className="flex items-center bg-[#004e45]  justify-center   lg:text-[15px]  text-[12px]  cursor-pointer z-40 lg:w-[250px] 
